...
from pySDC.projects.FluidFlow.FEniCSx.problem_classes.NavierStokes_2D_FEniCSx_matrix_forced_implicit import fenicsx_NSE_mass

from pySDC.projects.FluidFlow.FEniCSx.sweeper_classes.implicit_1st_order_mass_NSE import implicit_1st_order_mass_NSE
from pySDC.projects.FluidFlow.FEniCSx.sweeper_classes.implicit_1st_order_mass_NSE_MPI import implicit_1st_order_mass_NSE_MPI
...
def run_simulation(ml=None, mass=None):
    ...
    if mass:
        ...
        description['sweeper_class'] = implicit_1st_order_mass_NSE_MPI
