...
class fenicsx_heat_mass(Problem):
    ...
    def solve_system(self, rhs, factor, u0, t):
        ...
        self.solver.solve(self.tmp_f.x.petsc_vec, self.tmp_u.x.petsc_vec)
        # dolfinx.fem.petsc.set_bc(self.tmp_u.x.petsc_vec, [self.bc])
    ...
    def eval_f(self, u, t):
        ...
        self.M.mult(self.g.x.petsc_vec, self.tmp_f.x.petsc_vec)
