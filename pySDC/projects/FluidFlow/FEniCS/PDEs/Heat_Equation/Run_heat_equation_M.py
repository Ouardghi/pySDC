...
from pySDC.projects.FluidFlow.FEniCS.PDEs.Heat_Equation.problem_classes.HeatEquation_2D_FEniCS_matrix_forced import (
    fenics_heat2D_mass,
...
def run_simulation(ml=None, mass=None):
    ...
    path = path + "PDEs/Heat_Equation/data"
    ...
    json.dump(parameters, open(path + "/parameters.json", 'w'))
