...
from pySDC.projects.FluidFlow.FEniCS.PDEs.Navier_Stokes.problem_classes.NavierStokes_2D_FEniCS_matrix_forced import (
    fenics_NSE_2D,
    fenics_NSE_2D_mass,
    fenics_NSE_2D_mass_timebc,
)
from pySDC.implementations.sweeper_classes.imex_1st_order import imex_1st_order
from pySDC.projects.FluidFlow.FEniCS.PDEs.Navier_Stokes.sweeper_classes.imex_1st_order_mass_NSE import (
    imex_1st_order_mass_NSE,
)
...
def run_simulation(mass=None):
    ...
    description = dict()
    if mass:
        description['problem_class'] = fenics_NSE_2D_mass_timebc
