...
class fenics_ConvDiff(ptype):
    ...
    def __init__(self, c_nvars=64, t0=0.0, family='CG', order=2, refinements=1, nu=0.001, c=0.0, sigma =0.05):
        ...
        mesh = df.Mesh('/home/ouardghi/Desktop/pySDC-master/pySDC/projects/FluidFlow/FEniCS/cylinder.xml')        
        ...
        super(fenics_ConvDiff, self).__init__(self.V)
...
# noinspection PyUnusedLocal
class fenics_ConvDiff_mass(fenics_ConvDiff):
    r"""
    Example implementing the forced one-dimensional heat equation with Dirichlet boundary conditions
...
# noinspection PyUnusedLocal
class fenics_ConvDiff_mass_timebc(fenics_ConvDiff_mass):
    r"""
    ...
    def __init__(self, c_nvars=64, t0=0.0, family='CG', order=2, refinements=1, nu=0.001, c=0.0, sigma =0.05):
        ...
        path = '/home/ouardghi/Desktop/pySDC-master/pySDC/projects/FluidFlow/FEniCS/Output/T_dep/data10/'
    ...
    def u_exact(self, t):
        ...
        xdmffile_p0 = df.XDMFFile(path+'pressure.xdmf')
        xdmffile_u0 = df.XDMFFile(path+'velocity.xdmf')
        
        un = df.Function(self.V)
        pn = df.Function(self.Q)
        
        xdmffile_u0.read_checkpoint(un, 'u', 0)
        xdmffile_p0.read_checkpoint(pn, 'p', 0)
        
        me = self.dtype_u(df.interpolate(un, self.V), val=self.V)
