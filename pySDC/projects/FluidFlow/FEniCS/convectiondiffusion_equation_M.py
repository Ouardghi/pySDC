...
from pySDC.projects.FluidFlow.FEniCS.problem_classes.ConvectionDiffusion_2D_FEniCS_matrix_forced import fenics_ConvDiff_mass, fenics_ConvDiff_mass_timebc
from pySDC.projects.FluidFlow.FEniCS.problem_classes.ConvectionDiffusion_2D_FEniCS_matrix_forced import fenics_ConvDiff
...
def run_simulation(ml=None, mass=None):
    ...
    controller_params['hook_class'] = [fenics_output, LogStepSize]
