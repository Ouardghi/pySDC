...
from pySDC.projects.FluidFlow.PDEs.Navier_Stokes.problem_classes.NavierStokes_2D_FEniCS_monolithic import (
    fenics_NSE_2D_Monolithic,
)
from pySDC.projects.FluidFlow.PDEs.Navier_Stokes.sweeper_classes.implicit_NSE import implicit_NSE
